...
const WEBVIEW_COMPANIES = [
  ...
  { id: 'logistica',    name: 'Dua / Fedego! / Flash Mobile',  type_query: 'api_direct', personas: 'fisica_mx' },
  ...
  { id: 'mirlo',        name: 'Mirlo',                          type_query: 'api_direct', personas: 'fisica_mx_moral' },
...
const ERROR_COMPANIES = [
  { id: 'beneleit',       name: 'Beneleit Movil',               personas: 'fisica_mx', url: 'https://beneleit.mx/consultalineas/',                      errKey: 'err.proximamente',  knownSince: '05/05/2026' },
  { id: 'link_movil', name: 'Link Móvil', type_query: 'api_direct', personas: 'fisica_mx' },
  { id: 'megamovil', name: 'Megamóvil', type_query: 'api_direct', personas: 'fisica_mx' },
  { id: 'newww', name: 'Newww', type_query: 'api_direct', personas: 'fisica_mx' },
  { id: 'nextor',         name: 'Nextor Móvil',                 personas: 'fisica_mx', url: 'https://vinculacion.nextormovil.mx/',                       errKey: 'err.nextor',                         knownSince: '05/05/2026' },
  { id: 'red_aguila', name: 'Red Águila', type_query: 'api_direct', personas: 'fisica_mx' },
  { id: 'viralcel',       name: 'Viral Cel',                    personas: 'fisica_mx', url: 'https://www.viralcel.com/mi-linea',                         errKey: 'err.403',                            knownSince: '05/05/2026' },
  { id: 'wiicel_ind',     name: 'Wiicel (portal propio)',       personas: 'fisica_mx', url: 'https://wiicel.com/',                                       errKey: 'err.522',        knownSince: '05/05/2026' },
  { id: 'v_ahorrocel',    name: 'AhorroCel (VinculaTuLinea)',   personas: 'fisica_mx', url: 'https://vinculatulinea.com/freedompop/my-lines',                      errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_chedraui',     name: 'Chedraui Movil (VinculaTuLinea)', personas: 'fisica_mx', url: 'https://vinculatulinea.com/freedompop/my-lines',              errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_freedompop',   name: 'Freedompop (VinculaTuLinea)', personas: 'fisica_mx', url: 'https://vinculatulinea.com/freedompop/my-lines',                      errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_oxxocel',      name: 'OXXO CEL (VinculaTuLinea)',   personas: 'fisica_mx', url: 'https://vinculatulinea.com/freedompop/my-lines',                        errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_oui',          name: 'OUI (VinculaTuLinea)',         personas: 'fisica_mx', url: 'https://vinculatulinea.com/oui/my-lines',                    errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_ubercel',      name: 'Uber Cel (VinculaTuLinea)',    personas: 'fisica_mx', url: 'https://vinculatulinea.com/freedompop/my-lines',                        errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
  { id: 'v_yobi',         name: 'Yobi Telecom (VinculaTuLinea)', personas: 'fisica_mx', url: 'https://vinculatulinea.com/YobiTelecom/my-lines',                  errKey: 'err.403_vtl',               knownSince: '05/05/2026' },
];
